...
HRESULT DemoFramework::Init(const wchar_t* title, int width, int height, bool fullscreen)
{
    ...
    // camera
    m_view.CreateLookAt(Vector3(0, 2.0f, -5.0f), Vector3::Zero, Vector3::UnitY);
...
HRESULT DemoFramework::InitShaders()
{
...
void DemoFramework::RenderObj(const RenderMesh& rm, const RenderMaterial& mat, const Matrix& transform)
{
    ...
    m_pd3dDeviceContext->PSSetShaderResources(0, 1, nullptr);
...
RenderMaterial RenderMaterial::White( Vector4::One );